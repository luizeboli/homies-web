  ...
  return (
    <div className="flex grow flex-col rounded-xl bg-neutral-800">
      <div className="mt-auto flex items-center gap-4 p-6">
        ...
        />
        <button className="justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 p-2.5 text-center text-sm font-medium text-white hover:bg-gradient-to-l focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-neutral-900 disabled:cursor-wait disabled:opacity-60">
